...
public class C04_BlueRentalExcelTest {
    ...
    public void test01() {
        ...
        */
        ...
        BlueRentalPage rentalPage = new BlueRentalPage();//--> Locatelere ulasanilmek icin pageden obje yaptik.

        //Bir loop olusturup excel dosyasindaki tüm veriler ile login olalim.
        for (int i = 1; i <= reader.rowCount() ; i++) { //--> i'yi 1'den baslattik cünkü 0. indexte basliklar var.
